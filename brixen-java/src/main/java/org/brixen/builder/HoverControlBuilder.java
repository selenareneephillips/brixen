 ...
 *
 * <p>
 * {@code HoverControlBuilder} is used in conjunction with {@link HoverControlBean} and {@link LoadableFactory} to
 * construct page objects. It is designed to be extended by other builder {@code interfaces} for more complex page
 * objects in such a way that any setter function on {@code HoverControlBuilder} or an {@code interface} that
 ...
 *
 * @param <ControlT>    the type of web control that this {@code HoverControlBuilder} builds
 * @param <BeanT>       the data transfer object used to construct the web control that this
 *                      {@code HoverControlBuilder} builds
...
public interface HoverControlBuilder<
     ...
     * but the element is not really moused over.
     *
     * @param config    the configuration for the web control that specifies its dynamically configurable options
     * @return          this {@code HoverControlBuilder}, cast to its runtime type
     */
    BuilderT setHoverWithJavascript(HoverControlConfig config);
     ...
     * @return          this {@code HoverControlBuilder}, cast to its runtime type
     */
    BuilderT setUnhoverWithJavascript(HoverControlConfig config);
     ...
     * not related to testing that the hover actio alone triggers the desired side effects. In such cases, it would be
     ...
     * @return                      this {@code HoverControlBuilder}, cast to its runtime type
     */
    BuilderT setClickInsteadOfHover(boolean clickInsteadOfHover);

    /**
     * Enables or disables the {@link WebElement#click} action workaround for forcing the mouse to focus on the web
     * control with the setting from the specified configuration.
     * <p>
     * Note: It is best to use this in situations where both the {@link Actions#moveToElement} method and the
     * Javascript hover workaround fail silently, that is {@link Actions#moveToElement} and the Javascript hover
     * workaround run without throwing any {@code Exceptions}, but the element is not really moused over. This will
     ...
     * @return          this {@code HoverControlBuilder}, cast to its runtime type
     */
    BuilderT setClickInsteadOfHover(HoverControlConfig config);
     ...
     * @return          this {@code HoverControlBuilder}, cast to its runtime type
     */
    BuilderT setClickWithJavascriptInsteadOfHover(HoverControlConfig config);
     ...
     * @return          this {@code HoverControlBuilder}, cast to its runtime type
     */
    BuilderT setUnhoverWithClickInstead(HoverControlConfig config);
     ...
     * @return          this {@code HoverControlBuilder}, cast to its runtime type
     */
    BuilderT setUnhoverWithJavascriptClickInstead(HoverControlConfig config);
