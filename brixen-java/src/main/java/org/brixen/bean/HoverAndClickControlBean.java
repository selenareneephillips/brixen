...
public interface HoverAndClickControlBean extends ClickControlBean, PolleableBean {
    ...
    /**
     * Enables or disables the workaround for clicking the web control with Javascript instead of trying to execute a
     * mouseover on it first to make it visible.
     * <p>
     ...
     * visible, and this will allow automation of test cases which are dependent on the side effects generated by
