...
namespace Org.Brixen.Bean {
	...
	/// clickable.
	/// </summary>
	public interface IHoverAndClickControlBean : IClickControlBean, IPolleableBean {
		...
		/// Actions.MoveToElement(IWebElement)</see> method. This is useful in 
		...
		/// with Javascript rather than the 
		/// <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)">
		/// Actions.MoveToElement(IWebElement)</see> method. This is useful in 
		/// circumstances where the mouse over function fails silently, that is the 
		/// <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)">
		...
		/// <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)">
		/// Actions.MoveToElement(IWebElement)</see> method, the Javascript 
		/// hover workaround and the <see cref="OpenQA.Selenium.IWebElement.Click()">IWebElement.Click()</see> method 
		/// all fail silently, that is they all run without throwing any <c>Exceptions</c> but the element is not 
		/// really moused over or clicked. This will allow automation of test cases which are dependent on the side 
		/// effects generated by the hover action, but are not related to testing that the hover action alone triggers 
		/// the desired side effects. In such cases, it would be prudent to manually test the hover action alone in the 
		...
		/// <summary>
		/// Gets or sets the <see cref="OpenQA.Selenium.IWebElement.Click()">IWebElement.Click()</see> action 
		/// workaround for the unhover element which is used to focus the mouse in a safe location away from the web 
		/// control.
		/// <para>
		...
		/// mouse over the unhover element, so it should be used in situations where the see 
		/// <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)">
		/// Actions.MoveToElement(IWebElement)</see> method and the Javascript hover workaround fail silently, that is 
		/// see <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)">
		...
		/// <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)">
		/// Actions.MoveToElement(IWebElement)</see> method, the Javascript hover workaround and the 
		/// <see cref="OpenQA.Selenium.IWebElement.Click()">IWebElement.Click()</see> method fail silently, that is 
		/// they run without throwing any <c>Exceptions</c>, but the element is not really moused over or clicked.
		/// </summary>
