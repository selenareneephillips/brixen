...
namespace Org.Brixen.Bean {
	...
	public interface IHoverAndClickControlBean : IClickControlBean, IPolleableBean {
		...
		/// <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)"/> method. This is useful in 
		...
		/// <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)"/> method, the Javascript 
		...
		/// neither the <see cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)"/> nor the 
		/// Javascript hover workaround trigger the mouseover event and the expected side effect(s).
		/// </summary>
		...
		/// <cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)"/> 
		/// method and the Javascript hover workaround fail silently, that is see 
		/// <cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)"/> and the 
		/// Javascript hover workaround run without throwing any <c>Exceptions</c>, but the element is not really 
		/// moused over.
		/// </summary>
		...
		/// <cref="OpenQA.Selenium.Interactions.Actions.MoveToElement(IWebElement)"/> 
		/// method, the Javascript hover workaround and the <see cref="OpenQA.Selenium.IWebElement.Click()"/> method 
		/// fail silently, that is they run without throwing any <c>Exceptions</c>, but the element is not really 
