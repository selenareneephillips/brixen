...
namespace Org.Brixen.Bean {
	...
	public interface IControllableBean : IContentContainerBean {
		...
		/// </summary>
		/// <param name="name">The name of the web control.</param>
		/// <param name="unhoverWithJavascript">If <c>true</c>, enables the Javascript hover workaround for the unhover 
		...
		/// </summary>
		/// <param name="name">The name of the web control.</param>
		/// <param name="clickWithJavascript">If <c>true</c>, enables the Javascript click workaround; if <c>false</c>, 
		/// disables it.</param>
